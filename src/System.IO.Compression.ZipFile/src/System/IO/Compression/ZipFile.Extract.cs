...
namespace System.IO.Compression
{
    public static partial class ZipFile
    {
        ...
        public static void ExtractToDirectory(string sourceArchiveFileName, string destinationDirectoryName, Encoding entryNameEncoding, bool overwrite) => 
            ExtractToDirectory(sourceArchiveFileName, destinationDirectoryName, entryNameEncoding, overwrite, preservePermissions: false);
        ...
        ///     otherwise an <see cref="ArgumentException"/> is thrown.</para>
        /// </param>
        public static void ExtractToDirectory(string sourceArchiveFileName, string destinationDirectoryName, Encoding entryNameEncoding = null, bool overwrite = false, bool preservePermissions = false)
        {
            ...
            {
                archive.ExtractToDirectory(destinationDirectoryName, overwrite, preservePermissions);
            }
        }
    }
}
