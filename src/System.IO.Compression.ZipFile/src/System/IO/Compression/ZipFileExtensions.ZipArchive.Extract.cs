...
namespace System.IO.Compression
{
    public static partial class ZipFileExtensions
    {
        ...
        public static void ExtractToDirectory(this ZipArchive source, string destinationDirectoryName, bool overwrite) => ExtractToDirectory(source, destinationDirectoryName, overwrite);
        ...
        /// Relative path information is interpreted as relative to the current working directory.</param>
        /// <param name="overwrite">True to indicate overwrite.</param>
        /// <param name="preservePermissions">True to indicate that an attempt should be made to apply permissions information stored in the zip to the entries extracted.</param>
        public static void ExtractToDirectory(this ZipArchive source, string destinationDirectoryName, bool overwrite = false, bool preservePermissions = false)
        {
            if (source == null)
            ...
            {
                entry.ExtractRelativeToDirectory(destinationDirectoryName, overwrite, preservePermissions);
            }
        }
    }
}
